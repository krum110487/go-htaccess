...
func (Mod_auth_basic) DirAuthBasicAuthoritative(dir parser.DirectiveEntry, req *http.Request, runCtx *Context) error {
	//TODO: AuthBasicAuthoritative directive
	return errors.New("AuthBasicAuthoritative is not yet implemented")
}

func (Mod_auth_basic) DirAuthBasicFake(dir parser.DirectiveEntry, req *http.Request, runCtx *Context) error {
	//TODO: AuthBasicFake directive
	return errors.New("AuthBasicFake is not yet implemented")
}

func (Mod_auth_basic) DirAuthBasicProvider(dir parser.DirectiveEntry, req *http.Request, runCtx *Context) error {
	//TODO: AuthBasicProvider directive
	return errors.New("AuthBasicProvider is not yet implemented")
}

func (Mod_auth_basic) DirAuthBasicUseDigestAlgorithm(dir parser.DirectiveEntry, req *http.Request, runCtx *Context) error {
